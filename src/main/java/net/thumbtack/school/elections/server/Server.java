 ...
 *  Исправить класс Database для работы с map без циклов:
 *  Исправить CandidateMap: ключ - строка из имени и фамилии, значение - кандидат.
 *  Исправить VotersMap: ключ - UUID, значение - избиратель (для проверки валиден ли токен обратно добавить отдельный лист для валидных токенов).
 *  Исправить set предложений на map: ключ - строка, значение - предложение.
